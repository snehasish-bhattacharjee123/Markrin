    ...
    useEffect(() => {
        const fetchProducts = async () => {
            ...
            try {
                ...
                // Fallback mock data
                setProducts([
                    { _id: "1", name: "Classic White T-Shirt", price: 29.99, images: [{ url: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=500" }] },
                    { _id: "2", name: "Black Graphic Tee", price: 34.99, images: [{ url: "https://images.unsplash.com/photo-1512436991641-6745cdb1723f?w=500" }] },
                    { _id: "3", name: "Casual Blue T-Shirt", price: 19.99, images: [{ url: "https://images.unsplash.com/photo-1503342217505-b0a15ec3261c?w=500" }] },
                    { _id: "4", name: "Oversized Streetwear", price: 49.99, images: [{ url: "https://images.unsplash.com/photo-1618354691438-25bc04584c23?w=500" }] },
                    { _id: "5", name: "Minimal Grey T-Shirt", price: 24.99, images: [{ url: "https://images.unsplash.com/photo-1585386959984-a41552231693?w=500" }] },
                    { _id: "6", name: "Printed Fashion Tee", price: 59.99, images: [{ url: "https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=500" }] },
                ]);
            } finally {
                setLoading(false);
            }
                                        ...
                                        <div className="relative overflow-hidden rounded-2xl bg-gray-100 mb-4">
                                            ...
                                            <div className="absolute inset-x-0 bottom-0 p-4 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                                <div className="flex gap-2">
                                                    <button className="flex-grow py-3 bg-white text-brand-dark-brown font-bold text-xs uppercase tracking-wider hover:bg-brand-gold transition-colors flex items-center justify-center gap-2">
